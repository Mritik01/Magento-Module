...
class Display extends Template
{
    ...
    public function __construct(
        ...
        \Mobile\Redmi\Model\Mobiledata $customFactory, // Add your custom Model
        \Mobile\Redmi\Model\ResourceModel\Mobiledata\CollectionFactory $customdataCollection, // Add your custom Model
        array $data = []
    ) {
    ...
    {
        $this->pageConfig->getTitle()->set(('My Custom Pagination'));
        parent::_prepareLayout();
        $page_size = $this->getPagerCount();
        $page_data = $this->getCustomData();
        if ($this->getCustomData()) {
            $pager = $this->getLayout()->createBlock(\Magento\Theme\Block\Html\Pager::class,'custom.pager.name')
